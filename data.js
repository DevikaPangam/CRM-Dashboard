...
const CRM_CONFIG = {
  ...
  executives: [
    { name: 'Rahul Sharma', title: 'Senior BD Manager', email: 'rahul.s@corpbd.com' },
    { name: 'Ananya Verma', title: 'BD Lead - Enterprise', email: 'ananya.v@corpbd.com' },
    { name: 'Vikram Malhotra', title: 'Key Accounts Director', email: 'vikram.m@corpbd.com' },
    { name: 'Pooja Nair', title: 'BD Executive - North', email: 'pooja.n@corpbd.com' },
    { name: 'Siddharth Roy', title: 'BD Executive - West', email: 'siddharth.r@corpbd.com' }
  ],
  departments: [
    'Operations',
    'Pricing & Commercials',
...
const SEED_DATA = {
  ...
  activities: [
    ...
    },
    {
      ...
      nextAction: 'Final commercial sign-off meeting with MD & Procurement',
      nextActionOwner: 'Vikram Malhotra',
      nextFollowupDate: '2026-09-06',
      status: 'Completed',
  ...
  segments: [
    { id: 'SEG-01', name: 'Employee Transportation', code: 'ET-LOG', description: 'Corporate employee commute, cab fleet operations, shuttle buses and green EV transport.', head: 'Rahul Sharma', targetRevenue: 120000000, status: 'Active', dateAdded: '2026-01-10' },
    { id: 'SEG-02', name: 'Warehouse Logistics', code: 'WH-LOG', description: 'Grade-A dedicated warehousing, multi-client distribution centers, WMS software and inventory management.', head: 'Ananya Verma', targetRevenue: 100000000, status: 'Active', dateAdded: '2026-01-12' },
    { id: 'SEG-03', name: 'Fleet Management', code: 'FL-MGT', description: 'Enterprise fleet leasing, telematics, maintenance, fuel management and dedicated corporate drivers.', head: 'Pooja Nair', targetRevenue: 80000000, status: 'Active', dateAdded: '2026-01-15' },
    { id: 'SEG-04', name: 'Contract Logistics', code: 'CT-LOG', description: 'End-to-end 3PL / 4PL long-term contracts, supply chain planning, multimodal transport and packaging.', head: 'Siddharth Roy', targetRevenue: 90000000, status: 'Active', dateAdded: '2026-01-20' },
    { id: 'SEG-05', name: 'Corporate Travel', code: 'CP-TRV', description: 'Executive VIP travel, airport transfers, corporate event logistics and spot luxury car rentals.', head: 'Rahul Sharma', targetRevenue: 50000000, status: 'Active', dateAdded: '2026-02-01' },
    { id: 'SEG-06', name: 'Supply Chain Solutions', code: 'SC-SOL', description: 'Consulting, network optimization, freight forwarding, customs clearance and port handling.', head: 'Vikram Malhotra', targetRevenue: 110000000, status: 'Active', dateAdded: '2026-02-05' },
    { id: 'SEG-07', name: 'Last Mile Delivery', code: 'LM-DEL', description: 'E-commerce intracity delivery, hyper-local courier, dark store dispatches and return logistics.', head: 'Pooja Nair', targetRevenue: 60000000, status: 'Active', dateAdded: '2026-02-10' },
    { id: 'SEG-08', name: 'Cold Chain Logistics', code: 'CC-LOG', description: 'Temperature-controlled reefer trucks, cold storage, perishable pharma & food distribution.', head: 'Vikram Malhotra', targetRevenue: 75000000, status: 'Active', dateAdded: '2026-02-15' }
  ],

  teamMembers: [
    { id: 'BD-01', name: 'Rahul Sharma', title: 'Senior BD Manager', email: 'rahul.s@corpbd.com', phone: '+91 98201 22334', region: 'North Region', segment: 'Employee Transportation', target: 50000000, dateAdded: '2026-01-15', status: 'Active' },
    { id: 'BD-02', name: 'Ananya Verma', title: 'BD Lead - Enterprise', email: 'ananya.v@corpbd.com', phone: '+91 98110 44556', region: 'West Region', segment: 'Warehouse Logistics', target: 60000000, dateAdded: '2026-01-20', status: 'Active' },
    { id: 'BD-03', name: 'Vikram Malhotra', title: 'Key Accounts Director', email: 'vikram.m@corpbd.com', phone: '+91 99300 77889', region: 'South Region', segment: 'Cold Chain Logistics', target: 80000000, dateAdded: '2026-02-01', status: 'Active' },
    { id: 'BD-04', name: 'Pooja Nair', title: 'BD Executive - North', email: 'pooja.n@corpbd.com', phone: '+91 98450 11223', region: 'North Region', segment: 'Last Mile Delivery', target: 35000000, dateAdded: '2026-02-10', status: 'Active' },
    { id: 'BD-05', name: 'Siddharth Roy', title: 'BD Executive - West', email: 'siddharth.r@corpbd.com', phone: '+91 98230 99001', region: 'West Region', segment: 'Contract Logistics', target: 40000000, dateAdded: '2026-02-20', status: 'Active' }
  ],
